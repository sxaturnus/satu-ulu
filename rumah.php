<?php
  ...
  $query = "SELECT * FROM rumah ORDER BY rw ASC, rt ASC";
...
<head>
  ...
  <title>Statistik Rumah/Bangunan - Kelurahan 1 Ulu</title>
...
<body>
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="d-flex justify-content-end align-items-center">
          <ol>
            ...
            <li>Statistik Rumah/Bangunan</li>
          </ol>
        </div>
      </div>
    </section>
    ...
    <section class="inner-page">
      <div class="container">
        <h3 style="text-align: center;"><strong>Statistik Rumah/Bangunan</strong></h3>
