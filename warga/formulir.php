<?php
  ...
  // Query untuk mengambil data formulir dari database
...
<head>
  ...
  <title>Formulir - Kelurahan 1 Ulu</title>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="download.php?id_formulir=<?php echo $row['id_formulir']; ?>" class="btn btn-outline-info" target="_blank">
                    <i class="bi bi-cloud-arrow-down"></i> File
                  </a>
                </td>
              </tr>
              <?php
