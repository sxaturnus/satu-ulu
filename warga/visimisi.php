...
<head>
  ...
  <title>Visi Misi - Kelurahan 1 Ulu</title>
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
          Sesuai dengan visi dan misi dari Lurah 1 Ulu Kota Palembang, maka visi pembangunan Kelurahan 1 Ulu Kota Palembang, adalah:
        </p>
        <h2 class="text-center"><strong>VISI</strong></h2>
        <p class="text-center"><strong>“ PALEMBANG EMAS DARUSSALAM 2023 “</strong></p>
        <p class="text-center">EMAS yang menjadi Visi  mengandung makna, Elok Madani Aman dan Sejahtera sedang DARUSSALAM mengandung arti, Kota Palembang menjadi Kota yang Aman, Damai, Tentram, Makmur dan Sejahtera serta adanya harmoni antara kehidupan manusia dan alam.</p>
        ...
        <ol>
          ...
          <li>Mewujudkan masyarakat yang religius, berbudaya, beretika, melalui pembangunan budaya integritas yang didukung olehPemerintahan yang bersih, berwibawa dan profesional.</li>
          <li>Mewujudkan Palembang Kota yang dinamis sebagai simpul Pembangunan Regional, Nasional dan Internasional yang Kompetitif dan Komparatif dengan menjamin rasa aman untuk berinvestasi.</li>
