...
$data = mysqli_query($koneksi, "SELECT * FROM usia WHERE rw='$rw' AND rt='$rt'");
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        ...
                        <div class="heading-elements">
                            <a href="usia_tambah.php" class="btn btn-sm btn-primary" onclick="return checkDataExist()"><i class="icon-plus22"></i> TAMBAH</a>
                            <a href="usia_edit.php?rw=<?php echo $rw; ?>&rt=<?php echo $rt; ?>" class="btn btn-sm btn-success"><i class="icon-wrench"></i> Edit</a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped text-center">
                                ...
                                <?php
                                $koneksi = mysqli_connect("localhost", "root", "", "satu_ulu");
                                $data = mysqli_query($koneksi, "SELECT * FROM usia");
                                $no = 1;
