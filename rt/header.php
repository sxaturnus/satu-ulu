...
<head>
	...
	<title>Dashboard RT/RW - Kelurahan 1 Ulu</title>
		...
		<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu width-200">	
						...
						<li><a href="administrasi.php"><span>Permohonan Administrasi</span></a></li>
					</ul>
				</li>	
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<ul class="dropdown-menu width-200">
						...
						<li><a href="kelompok_usia.php"><span>Kelompok Usia</span></a></li>
