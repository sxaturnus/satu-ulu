            ...
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h4 class="panel-title">Tambah Data Statistik Agama & Pemeluk Kepercayaan</h4>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <form action="agama_act.php" method="post" id="form-tambah-agama" onsubmit="return validateForm()">
                                <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                        <th>AGAMA ISLAM</th>
                                        <td>
                                            <input class="form-control" type="number" name="islam" id="islam" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="katolik" id="katolik" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="protestan" id="protestan" required>
                                    ...
                                    <tr>
                                        <th>AGAMA HINDU</th>
                                        <td>
                                            <input class="form-control" type="number" name="hindu" id="hindu" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="budha" id="budha" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="khonghucu" id="khonghucu" required>
