...
if (!isset($_GET['rw']) || !isset($_GET['rt'])) {
    ...
    header("Location: kelompok_usia.php?status=not_found");
    exit();
}
...
$query = "SELECT * FROM usia WHERE rw='$rw' AND rt='$rt'";
$result = mysqli_query($koneksi, $query);
$data = mysqli_fetch_assoc($result);

if (!$data) {
    // Jika data tidak ditemukan, arahkan ke halaman rumah dengan pesan error
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='kelompok_usia.php';</script>";
    exit();
}
?>
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h4 class="panel-title">Edit Data Warga Berdasarkan Usia</h4>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <form action="usia_update.php" method="post" id="form-edit-usia" onsubmit="return validateForm()">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="form-control" type="hidden" name="id_usia" value="<?php echo $data['id_usia']; ?>">
                                            <input class="form-control" type="number" name="total_warga" id="total_warga" value="<?php echo $data['total_warga']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="balita_lk" id="balita_lk" value="<?php echo $data['balita_lk']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="balita_pr" id="balita_pr" value="<?php echo $data['balita_pr']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="ud_lk" id="ud_lk" value="<?php echo $data['ud_lk']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="ud_pr" id="ud_pr" value="<?php echo $data['ud_pr']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="remaja_lk" id="remaja_lk" value="<?php echo $data['remaja_lk']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="remaja_pr" id="remaja_pr" value="<?php echo $data['remaja_pr']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="dewasa_lk" id="dewasa_lk" value="<?php echo $data['dewasa_lk']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="dewasa_pr" id="dewasa_pr" value="<?php echo $data['dewasa_pr']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="lansia_lk" id="lansia_lk" value="<?php echo $data['lansia_lk']; ?>" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="number" name="lansia_pr" id="lansia_pr" value="<?php echo $data['lansia_pr']; ?>" required>
