				...
				<div class="panel panel-flat">
                    ...
                    <th width="15%">TANGGAL</th>
                      ...
                      <td><?php echo $d['pengumuman_tanggal'] ?></td>
											...
											<td>				
												<?php if($d['pengumuman_id'] != 1){ ?>
													<a class="btn border-danger text-danger btn-flat btn-icon btn-xs" href="pengumuman_hapus.php?id=<?php echo $d['pengumuman_id'];?>" onclick="return confirm('Apakah Anda yakin ingin menghapus pengumuman ini?');"><i class="icon-trash-alt"></i></a>
												<?php } ?>
											</td>
										</tr>
										<?php
