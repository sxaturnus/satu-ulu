...
<head>
  ...
  <title>Perizinan - Kelurahan 1 Ulu</title>
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <h2><strong>Perizinan</strong></h2>
        <p><strong>Jenis Perizinan</strong></p>
        <p>Jenis-jenis perizinan yang dapat diajukan dan diproses secara elektronik dapat dilihat berdasarkan kategori rumpun sebagai berikut:</p>
        <ul>
          <li>Perizinan Kegiatan Badan Usaha</li>
          <li>Perizinan Kegiatan Perorangan</li>
          <li>Perizinan Kelayakan Fungsi Bangunan</li>
          <li>Perizinan Kelayakan Usaha</li>
          <li>Perizinan Ketataruangan</li>
          <li>Perizinan Lingkungan</li>
          <li>Perizinan Pembangunan</li>
          <li>Perizinan Perorangan (Praktik/Lisensi)</li>
        ...
        <div class="container">
          <div class="card border-primary">
            ...
            <div class="card-body">
              <p class="card-text">Adapun persyaratan dokumen yang diperlukan dalam pengajuan perizinan yaitu:</p>
              <p class="card-text">
                <ol type="1">
                  <li>Perizinan dibedakan menjadi 2 kelompok, yaitu perusahaan dan perorangan.</li>
                  <li>Untuk mendaftar/memperoleh akun perusahaan/badan usaha, siapkan dokumen/data:</li>
                  <ul>
                  ...
                  <li>Untuk mendaftar/memperoleh izin perorangan, siapkan dokumen/data:</li>
                  <ul>
